...
def busca_facturas(M):
    ...
    :return:
    """
    #Crea directorio "Correos" a donde van a ir todos los folders con los correos.
    if not os.path.exists('Correos'):
        os.makedirs('Correos')
        os.chdir('Correos')
    else:
        os.chdir('Correos')
    ...
    for i in range(5):
        ...
        for num in data[0].split():
            ...
            # Crea directorio dentro por cada correo con el valor dateid
